    ...
    <>
      ...
      <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-indigo-500/10 to-violet-500/10 rounded-full blur-3xl" />
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-white/[0.02] border-white/10 hover:border-indigo-500/30 transition-all hover:-translate-y-1">
            <CardContent className="pt-8 pb-8 text-center flex flex-col items-center">
              <div className="w-16 h-16 bg-indigo-500/10 rounded-2xl flex items-center justify-center mb-6 border border-indigo-500/20 text-indigo-400">
              ...
              <a
                ...
                className="text-indigo-400 hover:text-indigo-300 transition-colors font-medium hover:underline mt-auto"
              >
          ...
          <Card className="bg-white/[0.02] border-white/10 hover:border-violet-500/30 transition-all hover:-translate-y-1">
            <CardContent className="pt-8 pb-8 text-center flex flex-col items-center">
              <div className="w-16 h-16 bg-violet-500/10 rounded-2xl flex items-center justify-center mb-6 border border-violet-500/20 text-violet-400">
              ...
              <a
                ...
                className="text-violet-400 hover:text-violet-300 transition-colors font-medium hover:underline mt-auto"
              >
                info@smbifylocal.com
              </a>
            </CardContent>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mb-20">
        <div className="rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-sm p-8 sm:p-12">
          ...
          <div className="space-y-8">
            <div>
              <h4 className="font-semibold text-indigo-400 mb-2">How do I get started?</h4>
            ...
            <div>
              <h4 className="font-semibold text-indigo-400 mb-2">Are my API keys safe?</h4>
              <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <div>
              <h4 className="font-semibold text-indigo-400 mb-2">Can I edit the generated website?</h4>
              <p className="text-gray-400 text-sm leading-relaxed">
        ...
        <div className="mt-8 text-center bg-white/[0.02] rounded-2xl border border-white/10 p-8">
          ...
          <p className="text-xs text-indigo-400 mt-4 px-4 py-2 inline-block bg-indigo-500/10 rounded-full border border-indigo-500/20">

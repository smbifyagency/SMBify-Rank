            ...
            <div className="space-y-2">
              ...
              {siblingPages.map((sibling) => (
                <Link
                  key={sibling.id}
                  href={sibling.href}
                  className="block rounded-lg border border-white/10 px-3 py-2 text-sm text-gray-300 hover:border-indigo-500/50 hover:bg-indigo-500/5 transition-colors hover:text-white"
                >
                    ...
                    {section.pages.map((sectionPage) => (
                      <Link
                        ...
                        className={`rounded-lg border px-3 py-2 text-sm transition-colors ${sectionPage.id === page.id
                            ...
                            : "border-white/10 text-gray-300 hover:border-indigo-500/50 hover:bg-indigo-500/5 hover:text-white"
                          }`}
                      >

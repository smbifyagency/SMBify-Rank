    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="bg-white border-gray-200 shadow-sm hover:border-[#7C3AED]/25 transition-all hover:-translate-y-1">
            <CardContent className="pt-8 pb-8 text-center flex flex-col items-center">
              ...
              <p className="text-gray-600 mb-6 text-sm">For general inquiries and support</p>
              <a
                href="mailto:info@sitegenie.app"
          ...
          <Card className="bg-white border-gray-200 shadow-sm hover:border-violet-500/30 transition-all hover:-translate-y-1">
            <CardContent className="pt-8 pb-8 text-center flex flex-col items-center">
              ...
              <p className="text-gray-600 mb-6 text-sm">Help with technical issues</p>
              <a
                href="mailto:info@sitegenie.app?subject=Technical Support"
                className="text-[#7C3AED] hover:text-[#9333EA] transition-colors font-medium hover:underline mt-auto"
              >
                info@sitegenie.app
              </a>
          ...
          <Card className="bg-white border-gray-200 shadow-sm hover:border-emerald-500/30 transition-all hover:-translate-y-1">
            <CardContent className="pt-8 pb-8 text-center flex flex-col items-center">
              ...
              <p className="text-gray-600 mb-6 text-sm">Share your suggestions</p>
              <a
                href="mailto:info@sitegenie.app?subject=Feedback"
      ...
      {/* FAQs */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto mb-20 bg-gray-50">
        <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-8 sm:p-12">
          <h3 className="text-2xl font-bold text-gray-900 mb-8 border-b border-gray-200 pb-4">Frequently Asked Questions</h3>
        ...
        <div className="mt-8 text-center bg-white rounded-2xl border border-gray-200 shadow-sm p-8">

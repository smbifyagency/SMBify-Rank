              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                {section.pages.map((page) => (
                  <Link
                    key={page.id}
                    href={page.href}
                    className="rounded-lg border border-white/10 px-3 py-3 text-sm text-gray-300 hover:border-[#7C3AED]/40 hover:bg-indigo-500/5 hover:text-white transition-colors"
                  >

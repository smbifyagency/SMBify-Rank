          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 w-full max-w-xl">
              <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden shadow-xl">
                ...
                {/* TODO: Replace with real screenshot — place image at /public/screenshots/hero-dashboard.png */}
                <img
                  src="/screenshots/hero-dashboard.png"
                  alt="SiteGenie AI Website Builder Dashboard — create professional websites in minutes"
                  className="w-full h-auto"
                  loading="eager"
                  onError={(e) => {
                    // Fallback wireframe if screenshot not yet added
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden shadow-lg">
              <div className="flex items-center gap-2 px-4 py-2.5 bg-gray-50 border-b border-gray-100">
                ...
                <span className="ml-2 text-xs text-gray-400">Website Builder</span>
              </div>
              {/* TODO: Replace with real screenshot — /public/screenshots/website-builder.png */}
              <img
                src="/screenshots/website-builder.png"
                alt="SiteGenie website builder interface showing AI content generation"
                className="w-full h-auto"
                loading="lazy"
                onError={(e) => {
              ...
              />
              <div className="hidden p-8 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center" style={{ minHeight: 240 }}>
                <p className="text-gray-400 text-sm">Screenshot: Website Builder</p>
              </div>
            </div>
            {/* Screenshot 2: Generated Website */}
            <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden shadow-lg">
              <div className="flex items-center gap-2 px-4 py-2.5 bg-gray-50 border-b border-gray-100">
                <span className="w-2.5 h-2.5 rounded-full bg-red-400" />
                <span className="w-2.5 h-2.5 rounded-full bg-yellow-400" />
                <span className="w-2.5 h-2.5 rounded-full bg-green-400" />
                <span className="ml-2 text-xs text-gray-400">Generated Website</span>
              </div>
              {/* TODO: Replace with real screenshot — /public/screenshots/generated-site.png */}
              <img
                src="/screenshots/generated-site.png"
                alt="A professional website generated by SiteGenie, deployed on Netlify"
                className="w-full h-auto"
                loading="lazy"
                onError={(e) => {
                  const t = e.currentTarget; t.style.display = 'none';
              ...
              />
              <div className="hidden p-8 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center" style={{ minHeight: 240 }}>
                <p className="text-gray-400 text-sm">Screenshot: Generated Website</p>
              </div>
            </div>
            {/* Screenshot 3: Blog Editor */}
            <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden shadow-lg">
              <div className="flex items-center gap-2 px-4 py-2.5 bg-gray-50 border-b border-gray-100">
                <span className="w-2.5 h-2.5 rounded-full bg-red-400" />
                <span className="w-2.5 h-2.5 rounded-full bg-yellow-400" />
              ...
              {/* TODO: Replace with real screenshot — /public/screenshots/blog-editor.png */}
              <img
                src="/screenshots/blog-editor.png"
                alt="SiteGenie AI blog post generator with bulk generation"
                className="w-full h-auto"
                loading="lazy"
                onError={(e) => {
                  const t = e.currentTarget; t.style.display = 'none';
              ...
              />
              <div className="hidden p-8 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center" style={{ minHeight: 240 }}>
                <p className="text-gray-400 text-sm">Screenshot: AI Blog Engine</p>
              </div>
            </div>
            {/* Screenshot 4: SEO & Deploy */}
            <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden shadow-lg">
              <div className="flex items-center gap-2 px-4 py-2.5 bg-gray-50 border-b border-gray-100">
                <span className="w-2.5 h-2.5 rounded-full bg-red-400" />
                <span className="w-2.5 h-2.5 rounded-full bg-yellow-400" />
              ...
              {/* TODO: Replace with real screenshot — /public/screenshots/deploy-seo.png */}
              <img
                src="/screenshots/deploy-seo.png"
                alt="SiteGenie one-click Netlify deployment with SEO schema markup"
                className="w-full h-auto"
                loading="lazy"
                onError={(e) => {
                  const t = e.currentTarget; t.style.display = 'none';
              ...
              />
              <div className="hidden p-8 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center" style={{ minHeight: 240 }}>
                <p className="text-gray-400 text-sm">Screenshot: Deploy & SEO</p>
              </div>
            </div>
          </div>
        </div>

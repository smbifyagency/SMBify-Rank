        ...
        <div className="min-h-[80vh] flex items-center justify-center px-4 py-20">
            <div className="text-center max-w-lg">
                <div className="w-20 h-20 rounded-2xl bg-[#AADD00]/10 flex items-center justify-center mx-auto mb-6">
                    <ArrowUpCircle className="h-10 w-10 text-[#AADD00]" />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
                        <Zap className="h-6 w-6 text-[#AADD00] mx-auto mb-3" />
                        ...
                        <Button onClick={() => setLocation("/pricing")} className="w-full mt-4 bg-gradient-to-r from-[#AADD00] to-[#7ec800]">
                            Upgrade to Pro
                        </Button>
                    </div>
                    <div className="rounded-2xl border border-[#AADD00]/25 bg-indigo-500/5 p-6">
                        <Building2 className="h-6 w-6 text-[#AADD00] mx-auto mb-3" />

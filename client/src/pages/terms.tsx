      ...
      <section className="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center border-b border-white/10 pb-8">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight mb-4">
            Terms & <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-400">Conditions</span>
          </h1>
        ...
        <div className="prose prose-invert prose-indigo max-w-none">
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed bg-indigo-500/10 border border-indigo-500/20 p-6 rounded-xl">

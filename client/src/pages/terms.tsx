      ...
      <section className="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center border-b border-white/10 pb-8">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight mb-4">
            Terms & <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#AADD00] to-[#7ec800]">Conditions</span>
          </h1>
          ...
          <div className="space-y-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                By accessing and using SMBify AI Static Website Builder ("the Service"), you agree to be bound by these Terms and Conditions.
            ...
            <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-8">
              ...
              <p className="text-gray-400 leading-relaxed mb-4">
                SMBify AI Static Website Builder is a public platform that allows users to create websites by providing their own API keys.
                The Service includes:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-[#bef000]Marker marker:text-indigo-500">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed bg-[#AADD00]/10 border border-[#AADD00]/20 p-6 rounded-xl">

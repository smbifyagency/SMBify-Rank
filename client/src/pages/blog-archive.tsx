    ...
    <div className="min-h-screen bg-gray-950 text-white pt-20">
      <div className="container mx-auto px-4 py-12">
                    ...
                    <Card key={post.id} className="group overflow-hidden hover:shadow-xl transition-all duration-300 bg-white/[0.02] border-white/10 backdrop-blur-sm">
                      {post.featuredImage && (
                        <div className="relative overflow-hidden">
                          ...
                          />
                          {post.isAiGenerated && (
                            <Badge className="absolute top-3 right-3 bg-indigo-600 hover:bg-indigo-500 text-white border-0">
                              AI Generated
                            </Badge>
                          )}
                        </div>
                      ...
                      <CardHeader>
                        ...
                        <CardTitle className="group-hover:text-indigo-400 text-white transition-colors line-clamp-2">
                          {post.title}
                        </CardTitle>
                    ...
                    <Card key={post.id} className="group hover:shadow-lg transition-all duration-300 bg-white/[0.02] border-white/10 backdrop-blur-sm">
                      {post.featuredImage && (
                        <div className="relative overflow-hidden">
                          ...
                          />
                          {post.isAiGenerated && (
                            <Badge className="absolute top-2 right-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs border-0">
                              AI
                            </Badge>
                          )}
                        </div>
        ...
        <div className="mt-16 text-center">
          <Card className="max-w-2xl mx-auto bg-gradient-to-r from-indigo-600/20 to-violet-600/20 border border-indigo-500/30">
            <CardHeader>
            ...
            <CardContent>
              <div className="flex gap-2">
                <Input
                  ...
                  className="bg-white/5 border-white/10 text-white placeholder:text-gray-400 focus:border-indigo-500"
                />
